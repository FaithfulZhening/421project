...
public class RoomChangeData {
	...
	public void setRoomChangeData(String roomNo,String start, String end){
		this.roomNo1 = roomNo;
		this.start = start;
		this.end = end;
	}
	public String changeRoom() throws SQLException{
	...
	private String check_calendar_op1(Date start_date , Date end_date , String room_type, String old_room_number) throws SQLException{
	...
	private String find_intersection_op1(ArrayList<Vector<String>> overall_date, String old_room_number){
		...
		public String find_intersection(ArrayList<Vector<String>> overall_date){
			for(int i = 0 ; i<overall_date.get(0).size();i++){
					int days = 0;
					String room = new String(overall_date.get(0).get(i));
					for(int j = 0 ; j < overall_date.size();j++){
