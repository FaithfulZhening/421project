...
public class Reservation {
	...
	private String start_date_input_str;
	private String end_date_input_str;
	private String room_type;
	private boolean online_reserved;
	private String payment_type;
		...
		public void setReservation(String first_name,String last_name,String phone, String email,
				boolean membership,String personal_id,String start_date_input_str,
				String end_date_input_str, String room_type, boolean online_reserved,
				String payment_type){
			...
			this.start_date_input_str = start_date_input_str;
			this.end_date_input_str = end_date_input_str;
			this.room_type = room_type;
			this.online_reserved = online_reserved;
